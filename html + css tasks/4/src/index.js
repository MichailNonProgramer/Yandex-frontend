...
document.getElementById('skip-button').addEventListener('click', () => make_swipe('left'));
document.getElementById('super-like-button').addEventListener('click', () => make_swipe('up'));
document.getElementById('like-button').addEventListener('click', () => make_swipe('right'));
